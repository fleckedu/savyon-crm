...
import { Search, Users, TrendingUp, Clock, Archive, X, Mail, Phone, Building2, MapPin, Globe, ChevronLeft, ChevronRight, Plus, Pencil, Check, Loader2, AlertCircle, LayoutGrid, Table2, ArrowRight } from "lucide-react";
      ...
      <div className="relative w-full max-w-md bg-white h-full shadow-2xl overflow-y-auto">
        ...
        <div className="p-5 space-y-5">
          ...
          <div className="border-t border-gray-100 pt-4 space-y-3">
            <div className="text-xs uppercase tracking-wide text-gray-400 font-medium">S&OP</div>
